...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    ro.bootimage.build.date.utc=1552992066 \
    ro.bootimage.build.date=Tue \
    Mar \
    18:41:06 \
    CST \
    2019 \
    ro.bootimage.build.fingerprint=HUAWEI/DRA-LX5RU/HWDRA-MG:8.1.0/O11019/1552992077:user/release-keys \
    ro.build.hw_emui_api_level=14 \
    ro.com.android.mobiledata=true \
    ro.config.BootFail=true \
    ...
    ro.ontim_default_write_disk=1 \
    ro.opa.eligible_device=true \
    ro.pg.platform.type=2 \
    ro.product.board=DRA-LX5 \
    ro.product.platform \
    ro.runmode=normal \
    ro.secure=1 \
    ro.sf.hwrotation=0 \
    ...
    ro.ussd_ksc5601=0 \
    ro.vendor.build.date.utc=1552992066 \
    ro.vendor.build.date=Tue \
    ro.vendor.product.brand=HUAWEI \
    ro.vendor.product.device=dura \
    ro.vendor.product.manufacturer=HUAWEI \
    ro.vendor.product.model=DRA-LX5 \
    ro.vendor.product.name=DRA-LX5RU \
